	...
	factory: (require) => {
		...
		*/
		function accountQuotaPercent(progress) {
			...
			if (fiveHour !== void 0) {
				if (fiveHour.percent === void 0) return weekly?.percent;
				if (fiveHour.percent > 0) return fiveHour.percent;
				return weekly?.percent ?? fiveHour.percent;
			}
			return weekly?.percent ?? progress.find((entry) => entry.percent !== void 0)?.percent;
		}
		...
		*/
		...
		function AccountOption({ account, model, selected, onChoose, t }) {
			const availability = accountAvailability(account, model);
			const percent = accountQuotaPercent(accountQuotaProgress(account.quota, t, model));
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						...
						children: percent === void 0 ? t("account.quotaUnknown") : `${Math.round(percent)}%`
					}),
